...
class FBSummary():
  ...
  """
    ...
    def __init__(self, picker, tr):
        ...
        self.cf = Ratio(self.tr, self.picker.t_long, self.picker.freqmin, self.cnr, self.perc_taper,
    ...
    """
        ...
        scnl, picks, trigger, snr = self.pick_ident()
        for i in range(len(picks)):
            ax.plot([(picks[i] - self.tr.stats.starttime), (picks[i] - self.tr.stats.starttime)],
